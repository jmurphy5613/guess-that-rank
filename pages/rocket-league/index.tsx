...
const ValorantHome = () => {
    ...
    useEffect(() => {
        if(!user) {
            ...
            axios.get('https://guessthatrank.herokuapp.com/clips/get-all/rl').then(e => {
        ...
        axios.get(`https://guessthatrank.herokuapp.com/guess/rl/not-guessed-clips/${user.nickname}`).then(e => {
            setIncompleteClips(e.data);
        });
        axios.get(`https://guessthatrank.herokuapp.com/guess/rl/guessed-clips/${user.nickname}`).then(e => {
