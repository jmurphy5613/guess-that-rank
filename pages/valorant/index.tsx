...
const ValorantHome = () => {
  ...
  useEffect(() => {
    ...
    if (user) {
      axios
        .get(
          `https://guess-that-rank-server-production.up.railway.app/guess/not-guessed-clips/val/${user?.nickname}`
        )
        .then((e) => {
          console.log(e.data);
      ...
      axios
        .get(
          `https://guess-that-rank-server-production.up.railway.app/guess/guessed-clips/val/${user?.nickname}`
        )
        .then((e) => {
